...
public class CommonAPI {
    ...
    @Parameters({"url"})
    @BeforeMethod
    public void setUp(@Optional("http://www.facebook.com") String url) {
        System.setProperty("webdriver.chrome.driver", "/Users/bibeksingh/GroupProject/WebAutomationTeam1-develop/browserdriver/chromedriver");
